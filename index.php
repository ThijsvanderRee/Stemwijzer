...
<body>
  <div id="start" class="">
    ...
    <div class="w3-container container mt0 dotted_top">
      <div class="holder">
        ...
        <p>Wat hebben de partijen in het verleden waargemaakt van hun verkiezingsbeloften? 'Track' uw stem met de Stemmentracker, een website die terugblikt op 30 Tweede Kamerstemmingen van de afgelopen regeerperiode. Met welke partij stemde u mee?
        </p>
      </div>
    </div>
  ...
  <div class="question_holder container w3-container w3-padding" id="qh_alt">
    <div class="holder">
      ...
      <button class="w3-round white bold question_button" type="button" name="button" style="float:right; margin-bottom: 20px;" onclick="result()">Naar resultaat</button>
    </div>
    <div class="holder" id="checkboxes_holder">
